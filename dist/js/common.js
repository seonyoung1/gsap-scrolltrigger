...
window.jas = function ($) {
  ...
  gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__["ScrollTrigger"].defaults({
  ...
  var common = {
    init: function init() {
      ...
      gsap__WEBPACK_IMPORTED_MODULE_1__["gsap"].from('.two .title', {
        scrollTrigger: twoOption,
        duration: 5,
        y: 250
      });
      gsap__WEBPACK_IMPORTED_MODULE_1__["gsap"].from('.two .desc', {
        scrollTrigger: twoOption,
        duration: 3,
        y: 300
      });
      gsap__WEBPACK_IMPORTED_MODULE_1__["gsap"].from('.three .title', {
        scrollTrigger: {
          trigger: '.three'
        },
        duration: 1,
...
/***/ 0:
/*!************************************************!*\
  !*** multi @babel/polyfill ./src/js/common.js ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
